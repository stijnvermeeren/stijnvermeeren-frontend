<template>
  ...
  <p>An overview of my trips into the outdoors in Switzerland since 2013.</p>
  <ul>
    <li>Summer activies (hiking, via ferrata, fell running, climbing, mountaineering) are shown in red.</li>
    <li>Winter activies (ski touring, snowshoe hiking, winter hiking) are shown in blue.</li>
    <li>Short local trips (short runs, Uetliberg explorations) are excluded.</li>
  </ul>

  <v-alert title="Warning / disclaimer" type="warning" density="compact" variant="outlined">
    These tracks are provided without any warranty about their accuracy, correctness or level of difficulty. Some routes might currently be subject to temporary or permanent trail closures, involve exposure to alpine risks (avalanches, rock falls, crevasses...) and/or require specialist mountaineering skills and equipment. Never follow a GPS track without proper planning, taking into account your own skills, experience and gear, the current conditions, the weather forecast, etc. Always consult guidebooks and/or online resources such as <a href="https://www.sac-cas.ch/de/huetten-und-touren/sac-tourenportal/">the SAC Tourenportal</a>, <a href="https://www.gipfelbuch.ch/">Gipfelbuch</a>, <a href="https://www.hikr.org/">Hikr</a>, <a href="https://map.geo.admin.ch/">map.geo.admin.ch</a>, <a href="https://map.wanderland.ch/">SchweizMobil</a>, <a href="https://whiterisk.ch/">WhiteRisk</a> and <a href="https://www.skitourenguru.ch/">Skitourenguru</a>, and contact local tourist offices or mountain huts where applicable.
  </v-alert>
